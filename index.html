    ...
    <div id="tab-registration" class="content-area active">
        ...
        <div class="card-section">
            ...
            <div class="form-group">
                ...
                <small style="color:var(--accent); cursor:pointer; font-weight:600; margin-top:5px; display:inline-block;" onclick="switchTab('conf')"> + Manage Addresses in Config</small>
            </div>
